Feature: Validate Dropdown Column Navigation and Page Access
    ...
    Scenario: Validate menu options
        ...
        And The url page should be equal to the next "https://www.kayak.com.co/stays" url
        ...
        And The url page should be equal to the next "https://www.kayak.com.co/cars" url
        ...
        And The url page should be equal to the next "https://www.kayak.com.co/explore/BOG-anywhere" url
        ...
        And The url page should be equal to the next "https://www.kayak.com.co/news/" url
        ...
        And The url page should be equal to the next "https://www.kayak.com.co/direct" url
        ...
        And The url page should be equal to the next "https://www.kayak.com.co/el-mejor-momento-para-viajar" url
        ...
        And The url page should be equal to the next "https://www.kayak.com.co/business" url
        ...
        And The url page should be equal to the next "https://www.kayak.com.co/trips" url

        When I click on the "menu" "button"
        And I click on the "menu_flights" "button"
        #Then I should be in the "flights" page
        Then The "home_message" "label" should contain the "Compara ofertas de vuelos en cientos de webs" text
        And The url page should be equal to the next "https://www.kayak.com.co/flights" url